...
<body>
    ...
    <section class="form6 cid-slmD1UvRNZ" id="form6-10">
        ...
        <div class="container">
            <div class="mbr-section-head">
                ...
                <h4 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-5">
                    Belum punya akun? Silahkan Register</h4>
            </div>
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                    <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler mx-auto"
                        data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true"
                            value="L3mX2g2Kao3rsc7QJDmTAKtSoThclKslX9vWTlnlmQs/HHV1K0RMNEU4d04JyEF8q09jaWWOSJwLnUaUXf5yGGHmIAX3fiUYROAWsusQ4vrX5w106fdMlShuaS4+QImA">
                        <div class="">
    ...
    <section style="display: none;"
        ...
        <p style="flex: 0 0 auto; margin:0; padding-right:1rem;">How to create a site - <a
                href="https://mobirise.site/x" style="color:#aaa;">See it</a></p>
    </section>
