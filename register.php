...
<body>
    ...
    <section class="form6 cid-slmDiT7kbK" id="form6-12">
        ...
        <div class="container">
            <div class="mbr-section-head">
                ...
                <h4 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-5">
                    Silahkan daftarkan diri Anda!</h4>
            </div>
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                    <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler mx-auto"
                        data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true"
                            value="FzV0zA3QkFAJNC25KTToEY4hgnrsfR3jmRvAh1jYfABg8Nfp+6gtRORT1TY3GqeOyk0GbXgADJZ68TmNYo4jzKWC+t3bvBmQFSeRaS83KFst6/cJTbymDXXwMFYMJzig">
                        <div class="">
    ...
    <section style="display: none;"
        ...
        <p style="flex: 0 0 auto; margin:0; padding-right:1rem;"><a href="https://mobirise.site/i"
                style="color:#aaa;">Created with Mobirise</a> creator</p>
    </section>
