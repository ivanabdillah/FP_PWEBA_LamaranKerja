...
<body>
    ...
    <section class="menu menu1 cid-slSNyRB0XA" once="menu" id="menu1-1f">
    ...
    <section class="form7 cid-slT5vQeK08" id="form7-1k">
                ...
                <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                    <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler mx-auto"
                        data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true"
                            value="2iu1dxcHvday6Bk3oWD8keGsoIm6D+nNsvHWIzEWmb62UUqLVhqW9atONYLWw5WA8sUXre1rQfASpzS87viCEskMnQoEmBtBTVC6dRUuPU6rH23Wbhe09VdvlHvzldSy">
                        ...
                        <div class="dragArea row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="email">
                                <input type="email" name="email" placeholder="Email" data-form-field="email"
                                    class="form-control" value="" id="email-form7-1k">
                            </div>
                            <div data-for="phone" class="col-lg-12 col-md-12 col-sm-12 form-group">
                                <input type="tel" name="phone" placeholder="Password" data-form-field="phone"
                                    class="form-control" value="" id="phone-form7-1k">
                            </div>
    ...
    <section class="footer7 cid-slSNVaAO9W" once="footers" id="footer7-1g">
    ...
    <section style="display: none;"
        ...
        <p style="flex: 0 0 auto; margin:0; padding-right:1rem;"><a href="https://mobirise.site/d"
                style="color:#aaa;">This site</a> was started with Mobirise</p>
    </section>
