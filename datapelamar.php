...
<body>
  ...
  <section class="menu menu1 cid-slSNyRB0XA" once="menu" id="menu1-1h">
  ...
  <section class="section-table cid-slT3MZ7iIL" id="table1-1j">
    ...
    <div class="container container-table">
      ...
      <h3 class="mbr-section-subtitle mbr-fonts-style align-center pb-5 mbr-light display-5">
        Berikut ini adalah daftar calon karyawan yang telah melamar di kantor kami
      </h3>
  ...
  <section class="footer7 cid-slSNVaAO9W" once="footers" id="footer7-1i">
  ...
  <section style="display: none;"
    ...
    <p style="flex: 0 0 auto; margin:0; padding-right:1rem;">Website was <a href="https://mobirise.site/g"
        style="color:#aaa;">designed</a> with Mobirise</p>
  </section>
